javascript:{
	...
	if(document.getElementById("searchAndReplace")) {
		document.body.appendChild(stylesNode);
		document.body.appendChild(formNode);	
	} else {
		console.log("bookmarklet appears to be installed already");
	}
	
	var f = function () {
		document.body.style.marginBottom = "76px"; //hack to fix bookmarklet after minifying
	}
	f();
}